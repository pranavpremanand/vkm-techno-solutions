...
export const WebDevelopment = () => {
  ...
  return (
    <div>
      ...
      <section id='features' className="sm:min-h-screen relative md:w-[95vw] overflow-hidden bg-white sm:-mt-[13rem]">
        <div className="wrapper py-14">
          <p data-aos="fade-right" className="text-2xl font-medium">An unmatched attendee</p>
          <h2 data-aos="fade-right" className="text-[4rem] sm:text-[7rem] md:text-[9rem] lg:text-[10rem] md:leading-[10rem] font-medium">
            Experience
          </h2>
          <div className="mt-2 sm:mt-14">
            <div className="grid sm:grid-cols-5 sm:grid-rows-[15rem_15rem_15rem_15rem] gap-5">
              <div data-aos="fade-right" class="sm:col-span-2 sm:row-span-1 p-4 lg:p-14">
              ...
              <div data-aos="fade-right" class="sm:col-span-2 sm:row-span-3 bg-[#6C666B]">
                <img
                  src={section2Img3}
      ...
      <section className="sm:min-h-screen text-white">
        <div className="wrapper pt-14">
          <p data-aos="fade-right" className="text-xl sm:text-2xl font-medium">Powered by</p>
          <div className="flex md:grid gap-2 md:gap-0 grid-cols-3 items-center grid-rows-3 mt-5">
            <h2 data-aos="fade-right" className="col-start-1 row-start-1 text-[2rem] sm:text-5xl md:text-[3.5rem] lg:text-[5rem] font-medium">
              VKM
            </h2>
            <h2 data-aos="fade-up" className="col-start-2 row-start-2 text-[2rem] sm:text-5xl md:text-[3.5rem] lg:text-[5rem] font-medium">
              Techno
            </h2>
            <h2 data-aos="fade-left" className="col-start-3 row-start-3 text-[2rem] sm:text-5xl md:text-[3.5rem] lg:text-[5rem] font-medium">
              Solutions
            </h2>
          </div>
          <div data-aos="fade-up" className="flex flex-col md:flex-row sm:justify-between bg-gradient-to-bl from-[#bea1a7] to-[#95b6cc] mt-8 md:mt-16 md:h-[60vh]">
      ...
      <section id='services' className="sm:min-h-screen bg-section4 bg-no-repeat bg-cover w-full mt-14">
        <div className="wrapper grid sm:grid-cols-[45%_53%] gap-5 pt-14">
          <h2 data-aos="fade-right" className="text-4xl sm:text-5xl leading-tight font-medium">
        ...
        <div className="bg-[#f5f5f5] overflow-hidden h-[70vh] relative flex items-center">
          <div className="wrapper">
            <div className="flex justify-center md:justify-normal gap-5">
              ...
              <div data-aos="fade-left" className="flex z-10 flex-col gap-5 justify-center ml-10">
        ...
        <div className="wrapper py-20">
          <h2 data-aos="fade-right" className="text-5xl sm:text-7xl font-medium text-white lg:text-black">
            Loved & <br /> trusted
          </h2>
      ...
      <section id='events' className="wrapper flex flex-col items-center justify-center pb-14 text-center md:py-20 text-white">
        <div data-aos="fade-up" className="flex flex-col gap-10 items-center w-full">
      ...
      <section id='blogs' className="bg-white text-black py-14">
        <div data-aos="fade-up" className="wrapper flex flex-col items-center justify-center">
      ...
      <section id='contact' className="bg-section7 bg-no-repeat bg-center bg-cover text-white">
      ...
      <section className="py-14 bg-white overflow-hidden">
        <div className="wrapper flex flex-col items-center gap-5 text-center">
          ...
          <button data-aos="fade-up" className="primary-btn">Request a demo</button>
